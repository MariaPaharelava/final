    ...
    public void initPoolData() {
        try {
            ...
            for (int i = 0; i < poolSize; i++) {
                ...
                /*Объект, который предоставляет хуки для управления пулом соединений.
                Объект PooledConnection представляет физическое соединение с источником данных.
                Соединение может быть переработано, а не закрыто, когда приложение закончено с ним,
                тем самым уменьшая количество соединений, которые необходимо выполнить.*/
