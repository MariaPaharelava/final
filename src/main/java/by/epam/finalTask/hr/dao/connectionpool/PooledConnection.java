...
final public class PooledConnection implements Connection{
    ...
    public PooledConnection(Connection connection,
                            ...
                            BlockingQueue<Connection> givenAwayConnectionQueue) throws SQLException {
        this.connection = connection;
        this.connection.setAutoCommit(true);
        this.connectionQueue = connectionQueue;
        this.givenAwayConnectionQueue = givenAwayConnectionQueue;
